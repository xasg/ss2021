                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="index.html" class="logo">
                             <img src="assets/images/logo-light.png" class="logo-lg" alt="" height="50">
                    ...
                    <div class="menu-extras topbar-custom navbar p-0">
                        <ul class="list-inline d-none d-lg-block mb-0">
                             <li class="hide-phone app-search float-left">
                                <p style="color: white; "> 
                                   <br> Dirección de Recursos Materiales, Abastecimientos y Servicios 
                                </p>
                            </li>
                        </ul>
                        ...
                        <ul class="mb-0 nav navbar-right ml-auto list-inline">
                            ...
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true">
                                    <img src="assets/images/users/avatar-1.png" alt="user-img" class="rounded-circle">
                                    <span class="profile-username">
                                                                Secretaría de Salud <span class="mdi mdi-chevron-down font-15"></span>
                                    </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="inicio.php" class="dropdown-item"> Inicio</a></li>
                                    <li class="dropdown-divider"></li>
                                    <li><a href="index.php" class="dropdown-item"> Salir</a></li>
                                </ul>
                            </li>
