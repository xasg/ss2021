                        ...
                        <div class="container-fluid">
                                ...
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            <div class="col-md-8">
                                                <h4 class="page-title m-0">Proveedores</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="m-b-30 m-t-0">Proveedores registrados: <?= $totalRows_reporte; ?></h4>
                                            <div class="row">
                                                <div class="col-lg-12 col-sm-12 col-12">
                                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                                        ...
                                                        ?>
                                                        <tr >
                                                            <td ><b><?=$row_reporte['proveedor']?></b></td>
                                                            <td class="text-left"><?php echo $row_reporte['contratos']; ?></td>
                                                            <td class="text-right">$<?php echo number_format($row_reporte['monto'], 2, '.', ','); ?></td>
                                                        </tr>
