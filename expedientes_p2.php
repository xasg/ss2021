                ...
                <div class="wrapper">
                        <div class="container-fluid">
                            ...
                            <?php
                                ...
                                $query="SELECT * FROM matriz_control WHERE periodo='II' ORDER BY contrato ASC";
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-12">
                                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td class="text-right"><a href="indexcss.php?id_exp=<?=$row_reporte['id_expediente']?>" target="_blank">Ver</a></td>
                                                        </tr>
